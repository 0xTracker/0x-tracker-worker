...
it('should get assets for V1 event args', () => {
  const event = eventWithArgs(V1_EVENT, {
    ...
    paidTakerFee: 0,
    tokens:
      '0xba6d84bb63fd28b7ca98ab0edf677fadd1354e572c830880c5ed0a2a0ff0cadb',
    orderHash:
...
it('should get assets for event with ERC-1155 asset data', () => {
  const event = eventWithArgs(V2_EVENT, {
    ...
    orderHash:
      '0xbdeaab6fac4aa9fb7109048bb72aeca9f151179cf345e19852f507f2ba1040e8',
    takerAddress: '0xd4690a51044db77d91d7aa8f7a3a5ad5da331af0',
    ...
    makerFeePaid: 1750000000000000.0,
    takerFeePaid: 0,
    protocolFeePaid: 180000000000000.0,
  });
  const assets = getAssetsForEvent(event);
